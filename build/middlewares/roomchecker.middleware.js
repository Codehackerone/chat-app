      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              user_model_1["default"].findOne({ _id: req.body.usertochatId }),
            ];
          case 1:
            usertochat = _a.sent();
            return [
              4 /*yield*/,
              room_model_1["default"].findOne({
                type: "dual",
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              room_model_1["default"].findById(req.body.room._id),
            ];
          case 1:
            room = _a.sent();
            if (!room) {
