...
this['about.txt'] = 'This is an experiment to see how much of the linux terminal can be replicated using only JavaScript/jQuery/Pug/Css.';
this['projects.txt'] = 'Ubuntu is a Debian-based Linux operating system for personal computers, tablets and smartphones, where Ubuntu Touch edition is used. It also runs network servers. That is usually with the Ubuntu Server edition, either on physical or virtual servers (such as on mainframes) or with containers, that is with enterprise-class features. It runs on the most popular architectures, including server-class ARM-based.';
this['loremipsum.txt'] = 'In publishing and graphic design, lorem ipsum is a filler text or greeking commonly used to demonstrate the textual elements of a graphic document or visual presentation. Replacing meaningful content with placeholder text allows designers to design the form of the content before the content itself has been produced.';
var files = ['about.txt', 'projects.txt'];
var allFiles = ['about.txt', 'projects.txt', 'loremipsum.txt'];
var user = 'root@user:~$';
var commandHistory = [];
var commandIndex = -1;
